...
class MediaPlayerFragment : Fragment() {
   ...
   // private var dummyButton: Button? = null
    ...
    //    dummyButton = view.findViewById(R.id.dummy_button)
        ...
        val model: MediaPlayerViewModel by viewModels()
        model.getStreamingUrl(serverId, uuid).observe(viewLifecycleOwner, Observer<String>{ streamingUrl ->
            Log.d("mediaplayer", streamingUrl)
            initPlayer(this.requireContext(), streamingUrl)
        })
    ...
    override fun onStart() {
        super.onStart()
        if(binding.exoPlayerFullScreen.player != null){
            binding.exoPlayerFullScreen.player!!.seekTo(currentWindow.toLong())
            binding.exoPlayerFullScreen.player!!.playWhenReady = true
        }
    }
    ...
    override fun onStop() {
        ...
        currentWindow = binding.exoPlayerFullScreen.player!!.currentPosition.toInt()
        binding.exoPlayerFullScreen.player!!.playWhenReady = false;
